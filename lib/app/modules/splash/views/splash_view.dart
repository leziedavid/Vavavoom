...
class _SplashScreenState extends State<SplashScreen> {
  ...
  final  colorizeColors = [ Color(0xfff6ff00), Colors.blue, Colors.blueAccent, Colors.white,];
      ...
      body: Container(
        ...
        child:Column(
          ...
          Container(
            ...
            child:AnimatedTextKit( animatedTexts: [ColorizeAnimatedText('vavavoom',textAlign: TextAlign.center,textStyle: TextStyle(fontSize: 50,fontWeight: FontWeight.bold,color: Colors.white, fontFamily: 'Aviano'), colors: colorizeColors, speed: const Duration(milliseconds: 1000),),],
              totalRepeatCount: 1,
