        ...
        child: ListView(
          ...
          children: [
                ...
                const ListTile(
                    ...
                    title: Text('Historique des billets que vous avez achetés', style: TextStyle(fontSize: 16,)),
                  ),
                          ...
                          child: ListView.separated(
                           separatorBuilder: (context, index) => Divider( color: Color.fromARGB(255, 255, 255, 255) ),
                            ...
                            Card(
                                ...
                                child: Column(
                                  children: [
                                    controller.listeTicketByUsers[index].statut == '0'?
                    ...
                    const Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text('Aucune historique disponible a ce jour...', style: TextStyle(fontSize: 16,color: const Color.fromARGB(255, 179, 0, 0)) ),
                            ],
                          ),
                        ): Container(  padding: EdgeInsets.all(10.sp),
