        ...
        child: ListView(
          ...
          children: [
                          ...
                          child: ListView.separated(
                           separatorBuilder: (context, index) => Divider( color: Color.fromARGB(255, 255, 255, 255) ),
                            ...
                            Card(
                                ...
                                child: Column(
                                  children: [
                                    controller.listeTicketByAdmin[index].statut == '0'?
                                    ...
                                    ListTile(
                                      ...
                                      trailing:Text('Code: ${controller.listeTicketByAdmin[index].code}',style: TextStyle(fontSize: 14,fontWeight: FontWeight.w700),),
                                      subtitle:Text("voyageur: ${controller.listeTicketByAdmin[index]!.nbreticket} personne(s)",
                                      style: TextStyle(fontSize: 14,fontWeight: FontWeight.w700),),
                                    ),
                ...
                Obx(()  => controller.etapes.value==true?
                    const Center(
                          child: Column(mainAxisSize: MainAxisSize.min,children: [ const Icon( Icons.error_outline_outlined,color: Colors.red,size: 100,),Text('Aucune historique disponible a ce jour...', style: TextStyle(fontSize: 16,color: const Color.fromARGB(255, 179, 0, 0)) ),], ),
                        ): Container(  padding: EdgeInsets.all(10.sp),
