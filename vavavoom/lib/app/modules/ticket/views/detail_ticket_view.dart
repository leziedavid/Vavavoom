...
import 'package:vavavoum/app/modules/paiement/views/paiement_view.dart';
import 'package:vavavoum/app/modules/ticket/controllers/ticket_controller.dart';
      ...
      Container(
        ...
        child: ListView(
          ...
          children: [
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Column(
                            children: [DottedDashedLine(height: 0,dashColor: Colors.grey, width: MediaQuery.of(context).size.width - 105.w,axis: Axis.horizontal),],
                          ),

                          Column(
                            children: [Text( "${data!.ville_depart} - ${data!.ville_arriver} " ,textAlign:TextAlign.center,style: TextStyle(fontFamily: "poppins",fontSize: 15.sp, color: Color.fromARGB(255, 0, 0, 0))),],
                          ),
                ...
                children: [
                  ...
                  Row(
                    children: [
                        ...
                        return Container(
                          ...
                          items: controller.item.map<DropdownMenuItem<String>>((String value) {
                              ...
                              controller.dropdownValue.value = value!;
                               controller.getPrice(controller.dropdownValue.value,data!.tarif);
                             },
                      ...
                      // Obx(
                      //   () {
                      //      return Container( width: 25.w, alignment: Alignment.center, child: Text(controller.nbPlace.value.toString(), style: TextStyle(  fontFamily: "poppins",  color: Colors.black,  fontSize: 16.sp),),
                      //     );
                      //   },
                      // ),
                      ...
                      // GestureDetector(
                      //   onTap: () { controller.incrementPlace(); },
                      //   child: Container(  padding: const EdgeInsets.all(5),  decoration: BoxDecoration(  color: CustomColor.primary, shape: BoxShape.circle,),
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [ 
                Text( "Total", style: TextStyle(fontFamily: "poppins", color: Colors.black,  fontWeight: FontWeight.w700, fontSize: 19.sp),),
                // Text("${controller.sommes.value}  fcfa",style: TextStyle( fontFamily: "poppins",color: Colors.black, fontWeight: FontWeight.w700,fontSize: 19.sp),),
                Obx(
                    () { 
                      return Text(
                          "${controller.montantTTC.value}  fcfa",style: TextStyle( fontFamily: "poppins",color: Colors.black, fontWeight: FontWeight.w700,fontSize: 19.sp),
                        );
                    },),
              ],
            )
