...
class SearchTicketByCode  extends GetView<TicketController> {
 ...
 TicketController controller = Get.put(TicketController());
  ...
  DateTime selectedDate = DateTime.now();
    ...
    void submit() async{
      controller.getTicketbyCode(codes.text);  
          }
        ...
        child: ListView(
          ...
          children: [
            ...
            const ListTile(
                ...
                title: Text('Entrer le code missionné sur le ticket', style: TextStyle(fontSize: 18, fontFamily: "poppins",)),
             ),
            ...
            // Obx(()  => controller.states.value==false && controller.telLength.value.length <=4 ?  GestureDetector(
            //       onTap:submit,
            //       child: Container(
            ...
            //           borderRadius: BorderRadius.circular(50),color: CustomColor.primary),
            //           child: const Text( "RECHERCHER",style: TextStyle(color: Colors.white, fontFamily: "poppins", ),
            //         ),
            //       ),
              ...
              Obx(()  => controller.stateSearch.value==true? 
                  Scrollbar(
                          ...
                          child: ListView.separated(
                           separatorBuilder: (context, index) => Divider( color: Color.fromARGB(255, 255, 255, 255) ),
                            ...
                            Card(
                                ...
                                child: Column(
                                  children: [
                                    controller.listeTicketByCode[index].statut == '0'?
                   ...
                   Obx(()  => controller.etapes.value==true?
                    Container(  padding: EdgeInsets.all(10.sp),alignment: Alignment.center,width: 250.w,
                          child: Text("Aucun achat n'est associé à ce code.",textAlign: TextAlign.center, style: TextStyle(fontSize: 20,color: const Color.fromARGB(255, 179, 0, 0),
                      )),
                    ) : Container(  padding: EdgeInsets.all(10.sp),
