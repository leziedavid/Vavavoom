...
import 'package:vavavoum/app/widgets/Cards/CardPaiement.dart';
        ...
        child: ListView(
          ...
          const Divider(  color: Colors.grey,  ),
            ...
            Row(
              ...
              children: [
                Text( "TOTAL", style: TextStyle(fontFamily: "popins", fontSize: 20.sp,fontWeight: FontWeight.w700), ),
                Text( "${data!.prix} Fcfa", style: TextStyle(fontFamily: "popins", fontSize: 20.sp,fontWeight: FontWeight.w700),
                ),
              ],
            ),
