...
class Itineraire {
    ...
    factory Itineraire.fromJson(Map<String, dynamic> json) => Itineraire(
          ...
          villeArriver : json['ville_arriver'],
          compagnieName : json['compagnie_name'],
          gare : json['gare'],
          heure : json['date_depart'],
          image_name : json['image_name'],
          // prixAllerRetour : json['aller_retour'],
          prixRetour : json['prix_retour'],
          prix : json['prix'],
    ...
    Map<String, dynamic> toJson() => {
          ...
          // 'prixAllerRetour':prixAllerRetour.toString(),
