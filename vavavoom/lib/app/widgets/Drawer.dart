        ...
        authController.onInit();
          ...
          return Drawer(
            child: ListView(
              ...
              children: [ Container( height: 70.h,color: CustomColor.primary, ), 
              ...
              const SizedBox( height: 5, ),
               ...
               Obx(() => authController.isAdmin.value==false && authController.isLogin==true
                ...
                Obx(() => authController.isAdmin.value==true && authController.isLogin==true
                ...
                Obx(() => authController.isLogin.value==true
                      ?  ListTile(
                          shape: const Border.symmetric( horizontal: BorderSide( width: 0.3, color: Color.fromARGB(141, 158, 158, 158)),  ),
