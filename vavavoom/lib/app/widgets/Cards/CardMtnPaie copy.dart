...
import 'package:vavavoum/app/modules/paiement/controllers/paiement_controller.dart';
                                        ...
                                        Container(
                                          ...
                                          child: GestureDetector(
                                                ...
                                                child: Container(
                                                  ...
                                                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(50),color: CustomColor.primary),child: const Text( "Effectuer un nouveau paiement",style: TextStyle(color: Colors.white, fontFamily: "poppins", ),
                                                  ),
                                                ),
                                            )
                                         ),
